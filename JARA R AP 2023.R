...
text(paste0("Change =",GIUCN$perc.risk[2],"%"),x=-59,y=0.135)
mtext(side=1,"Change (%)",line=1.6,las=1,cex=1.2)
# Namibia
par(mar=c(2.8,2.7,0.9,0.1),mgp=c(2,.75,0),yaxt="n",cex=1.1)
...
text(paste0("Change =",NIUCN$perc.risk[2],"%"),x=-59,y=0.234)
mtext(side=1,"Change (%)",line=1.6,las=1,cex=1.2)
# South Africa
par(mar=c(2.8,2.7,0.9,0.1),mgp=c(2,.75,0),yaxt="n",cex=1.1)
...
text(paste0("Change =",SIUCN$perc.risk[2],"%"),x=-59,y=0.121)
mtext(side=1,"Change (%)",line=1.6,las=1,cex=1.2)
dev.off()
